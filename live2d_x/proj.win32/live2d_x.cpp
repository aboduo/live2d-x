    ...
    int       nCmdShow)
{
    ...
    return Live2d_xPlayer::createAndRun();
}

int Live2d_xPlayer::createAndRun(void)
{
    Live2d_xPlayer *host = Live2d_xPlayer::sharedInstance();
    int ret = host->run();
    Live2d_xPlayer::purgeSharedInstance();
    return ret;
}

Live2d_xPlayer *Live2d_xPlayer::s_sharedInstance = NULL;

Live2d_xPlayer *Live2d_xPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Live2d_xPlayer();
    }
    return s_sharedInstance;
}

void Live2d_xPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
Live2d_xPlayer::Live2d_xPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int Live2d_xPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "live2d_x-player");
...
void Live2d_xPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void Live2d_xPlayer::createViewMenu(void)
{
...
void Live2d_xPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void Live2d_xPlayer::updateWindowTitle(void)
{
}

void Live2d_xPlayer::relaunch(void)
{
...
void Live2d_xPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void Live2d_xPlayer::onFileOpenProject(void)
{
...
void Live2d_xPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"Live2d_xPlayer");
...
void Live2d_xPlayer::onFileProjectConfig(void)
{
...
void Live2d_xPlayer::onFileRelaunch(void)
{
    relaunch();
}

void Live2d_xPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Live2d_xPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void Live2d_xPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void Live2d_xPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Live2d_xPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Live2d_xPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Live2d_xPlayer *host = Live2d_xPlayer::sharedInstance();
...
INT_PTR CALLBACK Live2d_xPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
